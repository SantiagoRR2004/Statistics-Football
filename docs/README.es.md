...
El programa va a tardar mucho más si lo ejecutas por primera vez. Si lo ejecutas y el archivo de resultados ya está creado el proceso va a ser mucho más rápido. Si ya hay resultado, como mínimo, añade mil nuevos datos.

La primera línea del programa establece la semilla. Si pones la semilla a cero y no hay resultados previos, la probabilidad de que el Celta no descienda es de 0.9323824 y la probabilidad de que el Atlético ascienda es del 0.9971473.
